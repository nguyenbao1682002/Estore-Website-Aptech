			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav navbar-nav topmenu-contact pull-left">
						<li><i class="fa fa-phone"></i> <span>Hotline: 0339 389 141</span></li>
					</ul>
					...
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-8">
						...
						<h1 class="pull-left">
							<a href="/home/index" class="logo"
								title="Hệ thống áo quần toàn quốc">
								<img src="https://i.imgur.com/TmlYTlz.png"
								alt="Hệ thống phân phối hản sản toàn quốc"
								title="Hệ thống áo quần toàn quốc"  style="width: 100px; height: 100px;">
							</a>
						</h1>
					...
					<div class="pull-right mobile-menu-icon-wrapper">
						...
						<div class="logo logo-mobile">
							...
							<a href="/home/index"
								...
								alt="Hệ thống áo quần toàn quốc">
							</a>
						</div>
						<!-- End Logo mobile -->
						<!-- Cart mobile -->
									...
									<c:forEach var="c" items="${danhmucSP}">
										<li class="level0"><a class=''
											href='/sanpham/danhsach-danhmuc/${c.maDanhMuc}'> <img
												class='icon-menu'
												src='https://sadesign.vn/wp-content/uploads/2021/04/cach-chup-anh-quan-ao-tre-em-dep.jpg'
												alt=''> <span>${c.tenDanhMuc}</span>
										</a>
									</c:forEach>
								</ul>
							</div>
