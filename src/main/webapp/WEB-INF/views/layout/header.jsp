					...
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-8">
						...
						<h1 class="pull-left">
							<a href="/home/index" class="logo"
								...
								<img src="https://tse1.mm.bing.net/th?id=OIP.Ta3DIrnIkBpa7yLqrrCWVgHaE8&pid=Api&P=0&h=180"
								alt="Hệ thống phân phối hản sản toàn quốc"
								title="Hệ thống phân phối hản sản toàn quốc"  style="width: 290px; height: 90px;">
							</a>
						</h1>
