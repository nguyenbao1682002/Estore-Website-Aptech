...
<div id="page">
    ...
    window.Shop = {"Name":"CÔNG TY CHUYÊN CUNG CẤP THỜI TRANG TOÀN QUỐC","Email":"ctytnhhtp@gmail.com","Phone":"(08) 33 44 00 22","Logo":"/Uploads/shop2005/images/logo.png","Fax":"(08) 66 85 85 38","Website":"http://www.runtime.vn","Hotline":"0908 77 00 95","Address":"5/12A Quang Trung, P.14, Q.Gò Vấp, Tp.HCM","Fanpage":"https://www.facebook.com/runtime.vn","Google":null,"Facebook":null,"Youtube":null,"Twitter":null,"IsBanner":false,"IsFixed":false,"BannerImage":null};
    ...
    $(".link-site-more").hover(function () { $(this).find(".s-c-n").show(); }, function () { $(this).find(".s-c-n").hide(); });
					...
					<div class="contact-content clearfix"
						...
						<div class="content clearfix">
							...
							<div class="col-md-5" id="col-right">
								...
								<hr class="line-right">
								<h3 class="name-company">NB FASHION SHOP</h3>
								<p>Thời trang số 1</p>
								<ul class="info-address">
									<li class="m-b-5"><i
										class="glyphicon glyphicon-map-marker m-r-5"></i> <span>38 Yên Bái</span>
									</li>
									<li class="m-b-5"><i
										class="glyphicon glyphicon-envelope m-r-5"></i> <span>nbfashionshop@gmail.com</span>
									</li>
									<li class="m-b-5"><i
										class="glyphicon glyphicon-phone-alt m-r-5"></i> <span>0852461608</span>
									</li>
								</ul>
							</div>
						</div>
        ...
        function moveToMaker(id) {
            ...
            old_id = id;
					...
					<!--End-->
					<script type="text/javascript">
    var firstMap= {"Id":2005,"ShopId":0,"Name":"CÔNG TY  CHUYÊN CUNG CẤP THỰC PHẨM HẢI SẢN TOÀN QUỐC","Address":"5/12A Quang Trung, P.14, Q.Gò Vấp, Tp.HCM","Phone":"(08) 66 85 85 38","PosX":10.844895933994351,"PosY":106.636744831799320,"Index":0,"Inactive":false};
    var Maps= [];
    window.Maps = Maps;
    window.Shop = {"Name":"CÔNG TY  CHUYÊN CUNG CẤP THỰC PHẨM HẢI SẢN TOÀN QUỐC","Email":"runecom04@runtime.vn","Phone":"(08) 66 85 85 38","Logo":"/Uploads/shop2005/images/logo.png","Fax":"(08) 66 85 85 38","Website":"http://www.runtime.vn","Hotline":"0908 77 00 95","Address":"5/12A Quang Trung, P.14, Q.Gò Vấp, Tp.HCM","Fanpage":"https://www.facebook.com/runtime.vn","Google":null,"Facebook":null,"Youtube":null,"Twitter":null,"IsBanner":false,"IsFixed":false,"BannerImage":null};
